        ...
        <div className="bg-gray-50 min-h-screen mt-10">
            ...
            <section className="max-w-7xl mx-auto px-6 py-20">
                ...
                <div className="text-center">
                    ...
                    <h1 className="text-5xl font-extrabold text-gray-900">
                        ...
                        About <span className="">UniGuide</span>
            ...
            <section className="max-w-6xl mx-auto px-6 py-16">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="bg-white rounded-3xl shadow-lg p-8 text-center hover:-translate-y-2 hover:shadow-xl transition-all duration-300">
            ...
            <section className="max-w-6xl mx-auto px-6 pb-20">
                ...
                <div className="bg-slate-800 rounded-3xl text-white text-center py-16 px-8">

                    <h2 className="text-4xl font-bold">
                        Ready to Find Your Dream University?
                    </h2>

                    <p className="mt-5 text-lg max-w-2xl mx-auto text-blue-100">
